...
# mediancost<-median(us_covid_healthcare_costs$avg_healthcarecost, na.rm=T)
# mediancaseincrease<-median(us_covid_healthcare_costs$avg_covidcases, na.rm=T)
# standardized_us_covid_healthcare_costs <- us_covid_healthcare_costs %>% 
