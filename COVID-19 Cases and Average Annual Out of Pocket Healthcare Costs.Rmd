...
Our regression analysis indicates that when rank of county increased by one in regard to the average COVID-19 cases in 2021, average annual out of pocket healthcare cost in 2022 increased by approximately 11 cents when keeping 2022 covid-19 case rank constant. The 2021 data was not statistically significant at a p-value of 0.05. On the other hand, when rank of county increased by one in regard to the average COVID-19 cases in 2022, average annual out of pocket healthcare cost in 2022 increased by approximately 48 cents when keeping 2021 covid-19 case rank constant. This was statistically significant at a p-value of 0.05, but not very relevant in actuality due to the increase in average annual out of pocket healthcare costs per person being by less than half a dollar for each rank increase. Also, the rank of the county is a variable we created as a mechanism of visualizing trends in our data; therefore, regression analysis using rank is not necessarily indicative of a tangible trend.

---

### Conclusions

All in all, our statistical analyses have not elucidated a clear relationship between out-of-pocket healthcare costs and COVID-19 cases, and we also did not find any predictive power of COVID-19 cases as a predictor for out-of-pocket healthcare costs. Certainly, variables that we did not consider in this data such as cost of living differences between counties could be confounding to the predictive power of COVID-19 cases; however, the data sets we utilized lacked a way to incorporate this data into our study. Undoubtedly, the COVID-19 pandemic is still a relatively new global event, so any absence in trends between our two variables does not mean these trends will not be evident later as the longitudinal effects of the pandemic continue to develop.
