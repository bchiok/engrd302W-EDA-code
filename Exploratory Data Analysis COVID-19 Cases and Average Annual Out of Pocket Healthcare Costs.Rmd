---
title: "Exploratory Data Analysis: COVID-19 Cases and Average Annual Out of Pocket Healthcare Costs"
...
cor3 <- cor(covid_healthcarecosts$rank2021case, covid_healthcarecosts$rank2022cost)
print(cor3)
cor4 <- cor(covid_healthcarecosts$rank2022case, covid_healthcarecosts$rank2022cost)
print(cor4)
...
mlr_rank <- lm(avg_cost_2022 ~ rank2021case * rank2022case, data = covid_healthcarecosts)
summary (mlr_rank)

model <- aov(avg_cost_2022 ~ rank2021case * rank2022case, data = covid_healthcarecosts)
summary(model)
